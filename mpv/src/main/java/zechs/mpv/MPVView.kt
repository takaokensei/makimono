...
class MPVView(
    ...
    private fun initOptions(configDir: String) {
        ...
        // Subtitle typesetting (clean styling for standard tracks, respect natural ASS positioning)
        MPVLib.setOptionString("sub-font", "sans-serif-medium")
        ...
        MPVLib.setOptionString("sub-border-size", "2.8")
